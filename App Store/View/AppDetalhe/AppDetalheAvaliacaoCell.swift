...
class AppDetalheAvaliacaoCell: UICollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let tituloLabel: UILabel = .textboldLabel(text: "Avaliações e opinições", fontSize: 24)
...
class ComentarioCell: UICollectionViewCell {
    ...
    let comentarioLabel: UILabel = .textboldLabel(text: "Recomendo bastante esse app, está me ajudando muito", fontSize: 16, numberOfLines: 0)
